  ...
  return (
    <section className="screen profile-screen">
      ...
      <div className={`profile-grid${!created ? ' profile-grid--create' : ''}`}>
        {created && (
          <div className="profile-card" role="region" aria-label={t(lang, 'profile')}>
            <p className="profile-name">
              ...
              <span>
                {profile.name}
                <span className="profile-level-tag mono">
                  {t(lang, 'profileLevel')} {profile.level}
                </span>
              </span>
            </p>
            <p className="meta mono">
              {t(lang, 'profileXp')} {profile.xp}/{need}
            </p>
            <div
              className="xp-bar"
              role="progressbar"
            ...
            <dl className="profile-stats">
              ...
              <div>
                ...
                <dd className="mono profile-stat-accent">{profile.highScore}</dd>
              </div>
              <div>
        ...
        <div className="profile-edit setup-panel">
