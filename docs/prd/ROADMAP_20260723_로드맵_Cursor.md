...
- [~] (선택) KataGo 분석 색칠(숫자+라벨) — 힌트 상위 3수 라벨 표시
...
- [x] 룰 선택(일본/중국) + 덤
- [~] 접근성 점검 체크리스트 통과 (저시력 사용자 피드백) — 포커스 #FFFF00, 힌트 H·스크린리더 안내
- [~] 배포 파이프라인 + 서명된 데스크톱 빌드 — gh-pages·CI·Tauri NSIS; OV/EV 인증서 연결 시 정식 서명
- [~] Outline 위키·랜딩 페이지 정합 — 로컬 위키/README 0.6.x 동기화 (Outline MCP 재연결 후 원격 반영)
